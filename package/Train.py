...
# Load the data
train_data = pd.read_csv(r'D:\asu\Semester 6 - Spring 23\CSE472 - Artificial Intelligence\Der3 version/normalized_train.csv')
valid_data = pd.read_csv(r'D:\asu\Semester 6 - Spring 23\CSE472 - Artificial Intelligence\Der3 version/val.csv')
test_data = pd.read_csv(r'D:\asu\Semester 6 - Spring 23\CSE472 - Artificial Intelligence\Der3 version/test.csv')
