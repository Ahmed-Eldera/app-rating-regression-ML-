...
# === Load the test data ===
test_data = pd.read_csv(r'D:\asu\Semester 6 - Spring 23\CSE472 - Artificial Intelligence\another version of Der3 version\Der3 version\normalized_test.csv')
...
model = joblib.load(r'D:\asu\Semester 6 - Spring 23\CSE472 - Artificial Intelligence\another version of Der3 version\Der3 version\Lasso_model.joblib')  # or 'RandomForest_model.joblib', etc.
